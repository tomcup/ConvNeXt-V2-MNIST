...
from src.utils import build_logger, set_seed
...
def main():
    parser = argparse.ArgumentParser(
        description="Train ConvNeXt V2 Femto on augmented MNIST"
    )
    parser.add_argument(
        "--config", type=str, default="config/default.yaml", help="Configuration YAML"
    )
    parser.add_argument(
        "--device", type=str, default=None, help="Device override (e.g. cuda:0, cpu)"
    )
    parser.add_argument(
